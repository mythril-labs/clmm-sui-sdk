...
func ComputeSwapStep(sqrtRatioCurrentX64, sqrtRatioTargetX64, liquidity, amountRemaining *big.Int, feePips constants.FeeAmount) (sqrtRatioNextX64, amountIn, amountOut, feeAmount *big.Int, err error) {
